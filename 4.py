...
def read_ip_write_to_file(): # создаем функцию
    ...
    video_writer=cv2.VideoWriter(r"C:\Users\Honor\Downloads\lr1\vid1.avi",fourcc,25,(w,h))
    while True: # цикл, который записывает видео
        ok,img=video.read() # первый кадр
        cv2.imshow('img',img) # отображение кадра в окне
